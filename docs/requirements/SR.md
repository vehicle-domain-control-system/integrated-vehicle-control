...
- 유효한 잠금 요청에 따라 문이 실제로 잠겼고 정상 완료가 확인되면 잠금 완료음을 제공해야 한다. 문이 이미 정상적으로 잠겨 있어 구동 없이 요청을 완료한 경우에는 새 완료음을 제공하지 않아야 한다.
- 유효한 잠금 해제 요청에 따라 문이 실제로 잠금 해제됐고 정상 완료가 확인되면 잠금 완료음과 구분되는 음향을 제공해야 한다. 문이 이미 정상적으로 잠금 해제되어 구동 없이 요청을 완료한 경우에는 새 완료음을 제공하지 않아야 한다.
